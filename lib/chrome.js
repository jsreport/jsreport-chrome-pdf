...
const chromePagePoolStrategy = require('./chromePagePoolStrategy')
...
function execute (reporter, definition, strategyCall, imageExecution) {
  ...
  return async (req, res) => {
    ...
    const id = uuid()
    const htmlPath = path.join(reporter.options.tempAutoCleanupDirectory, `${id}-${imageExecution ? 'chrome-image' : 'chrome-pdf'}.html`)
...
module.exports = function (reporter, definition) {
  ...
  if (
    ...
    definition.options.strategy !== 'chrome-page-pool'
  ) {
  ...
  if (definition.options.strategy === 'chrome-pool' || definition.options.strategy === 'chrome-page-pool') {
  ...
  } else if (definition.options.strategy === 'chrome-page-pool') {
    strategyCall = chromePagePoolStrategy({ reporter, puppeteer, options: definition.options })
  }
